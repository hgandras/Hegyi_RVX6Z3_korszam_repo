...
template<typename T>
auto D(T x,const T f,const T q,const T h,const T a,const T delta){

    return (func_kotel(x+delta,f,q,h,a)-func_kotel(x-delta,f,q,h,a))/(2*delta);
}

template<typename T>
auto S(T x,const T f,const T q,const T h,const T a,const T delta){
...
template<typename T>
auto hatod_deriv(T x,const T f,const T q,const T h,const T a,const T delta){
